...
import RecvMessage from "main/room-mobile/components/SidebarChat/RecvMessage"
import SentMessage from "main/room-mobile/components/SidebarChat/SentMessage"
...
function Messages() {
    ...
    return (
        <div
            className=" meeting-chat-content px-4 mt-4 overflow-y-scroll relative"
            style={{
            ...
            <>
                {unreadCount >= 1 ?
                    <Tooltip placement="topLeft" title="Có tin nhắn mới!">
                        <div className="scroll-bottom  new-message absolute bottom-22.5"
                            style={{
                                color: "white",
                                fontSize: "27px",
                            }}
